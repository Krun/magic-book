...
% Ahora tenemos que ver cuales de las candidatas se pueden usar realmente como reglas
% Enfoque: Tomar todas las reglas como finales y calcular su performance.
% Luego simplemente nos quedamos con aquellas reglas que tengan mejor performance
% Primero hay que definir los parametros de performance
% Lueog hay que definir el procedimiento de evaluacion
% Al final, obtenemos un conjunto de reglas que han demostrado una buena performance, y de paso tenemos la probabilidad para cada regla
